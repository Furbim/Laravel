...
Route::post('/addMoedas-user', [UserController::class, 'addMoedas'])->name('user.addMoedas');
Route::post('/removeMoedas-user', [UserController::class, 'removeMoedas'])->name('user.removeMoedas');
